...
//include_once ( get_home_path() .DIRECTORY_SEPARATOR.'wp-admin'. '/admin.php' );
...
if (!empty($_POST['action']) && ($_POST['action'] == "doremove")) {
    echo "success";
    die();
}
...
$args['screen'] = convert_to_screen( 'users' );
set_current_screen($args['screen']);
$wp_list_table = new WP_Users_Custom_List_Table($args);
$pagenum = $wp_list_table->get_pagenum();
$title = __('Users');
$parent_file = 'users.php?page=users-custom';
...
if ( empty($_REQUEST) ) {
    ...
    $redirect = 'users.php?page=users-custom';
    $referer = '';
}
...
switch ( $wp_list_table->current_action() ) {
    ...
    <?php endif;
        ...
        <div class="wrap">
            ...
            <form method="post" action="users.php?page=users-custom">
